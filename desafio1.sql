...
INSERT INTO SpotifyClone.Albums (title, release_year, artist_id)
VALUES
	("Envious", 1990, 1),
  ("Exuberant", 1993, 1),
...
INSERT INTO SpotifyClone.Songs (name_song, seconds_duration, album_id)
VALUES
	("Soul For Us", 200, 1),
...
INSERT INTO SpotifyClone.Users (name_user, age, plan_id)
VALUES
	("Thati", 23, 1),
  ("Cintia", 35, 2),
  ("Bill", 20, 3),
...
INSERT INTO SpotifyClone.Signatures(signature_date, plan_id, user_id, `active`)
VALUES
	("2019-10-20", 1, 1, 1),
  ("2017-12-30", 2, 2, 1),
  ("2019-06-05", 3, 3, 1),
...
CREATE TABLE SpotifyClone.PlayHistory(
...
INSERT INTO SpotifyClone.PlayHistory (song_id, playback_date, user_id)
VALUES
...
CREATE TABLE SpotifyClone.FollowersArtists(
  artist_id INT NOT NULL,
  user_id INT NOT NULL,
...
INSERT INTO SpotifyClone.FollowersArtists (user_id, artist_id)
VALUES
	(1, 1),
  (1, 4),
  (1, 3),
